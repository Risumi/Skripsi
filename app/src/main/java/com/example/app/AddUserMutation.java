...
public final class AddUserMutation implements Mutation<AddUserMutation.Data, AddUserMutation.Data, AddUserMutation.Variables> {
  public static final String OPERATION_ID = "1da3d438d3930a402a7c373df461f157aa2977c56303a49b15b7d7896c634bce";

  public static final String QUERY_DOCUMENT = "mutation AddUser($idProject: String!, $email: String!) {\n"
      + "  addUser(idProject: $idProject, email: $email) {\n"
      + "    __typename\n"
      + "    idProject\n"
      + "    email\n"
      + "    name\n"
  ...
  public AddUserMutation(@NotNull String idProject, @NotNull String email) {
    Utils.checkNotNull(idProject, "idProject == null");
    Utils.checkNotNull(email, "email == null");
    variables = new AddUserMutation.Variables(idProject, email);
  }
  ...
  public static final class Builder {
    ...
    public AddUserMutation build() {
      Utils.checkNotNull(idProject, "idProject == null");
      Utils.checkNotNull(email, "email == null");
      return new AddUserMutation(idProject, email);
    }
  }
  ...
  public static class Data implements Operation.Data {
    static final ResponseField[] $responseFields = {
      ResponseField.forObject("addUser", "addUser", new UnmodifiableMapBuilder<String, Object>(2)
    ...
    final @Nullable AddUser addUser;
    ...
    public Data(@Nullable AddUser addUser) {
      this.addUser = addUser;
    }

    public @Nullable AddUser addUser() {
      return this.addUser;
    }
    ...
    public ResponseFieldMarshaller marshaller() {
      return new ResponseFieldMarshaller() {
        ...
        public void marshal(ResponseWriter writer) {
          writer.writeObject($responseFields[0], addUser != null ? addUser.marshaller() : null);
        }
      };
    }
    ...
    public boolean equals(Object o) {
      ...
      if (o instanceof Data) {
        Data that = (Data) o;
        return ((this.addUser == null) ? (that.addUser == null) : this.addUser.equals(that.addUser));
      }
      return false;
    }
    ...
    public static final class Mapper implements ResponseFieldMapper<Data> {
      ...
      public Data map(ResponseReader reader) {
        final AddUser addUser = reader.readObject($responseFields[0], new ResponseReader.ObjectReader<AddUser>() {
          @Override
          public AddUser read(ResponseReader reader) {
            return addUserFieldMapper.map(reader);
          }
        });
        return new Data(addUser);
      }
    }
  }
  ...
  public static class AddUser {
    ...
    public AddUser(@NotNull String __typename, @Nullable String idProject, @Nullable String email,
    ...
    public static final class Mapper implements ResponseFieldMapper<AddUser> {
      ...
      public AddUser map(ResponseReader reader) {
        ...
        return new AddUser(__typename, idProject, email, name);
      }
    }
  }
}
